...
# l = json.loads(countries)
# res = set()
# for i in l:
#     res.add(i["english_name"])
# for i in res:
#    db.insert_countrie(i)
...
for i in range(len(moviesss)):
    ...
    #     db.insert_score(m.id, int(10 * float(m2.values["imdbRating"])), tomatoes, metascore,
    #                     int(m2.values["imdbVotes"].replace(',', '')))
    #     rated = None
    ...
    #             if gender == 2:
    #                 gender = None
    #             db.insert_actor(first, last, gender, person["profile_path"])
    ...
    #                 if gender == 2:
    #                     gender = None
    #                 db.insert_actor(first, last, gender, crew["profile_path"])
